 ...
 * @author hubanato
 */
public class AuthenticationAdvisorForm extends javax.swing.JFrame {

    /**
     * Creates new form ClientForm
     */
    public AuthenticationAdvisorForm() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AuthenticationAdvisorForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AuthenticationAdvisorForm().setVisible(true);
            }
        });
    }
