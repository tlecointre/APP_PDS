 ...
 * @author hubanato
 */
public class Client_Old extends Person {
     ...
     * @param job
     */
    public Client_Old(String civility, String name, String firstName, Date birthDate, String birthPlace, String sex, String nationality, int number, String street, String add, int cp, String city, String country, int pNumber, int pHome, int pBusiness, String email, String job) {
     ...
     * @throws SQLException
     */
    public static Client_Old getById(int id) throws SQLException {
        Connection connexion = PdsDatabase.getConnection();
        ...
        ResultSet rs = ordre.executeQuery();
        if (rs.next()) {
            return new Client_Old(rs.getString("CIVILITY"), rs.getString("NAME"), rs.getString("FIRST_NAME"),
     ...
     * @throws SQLException
     */
    public static ArrayList<Client_Old> getByName(String name, String firstName) throws SQLException {
        Connection connexion = PdsDatabase.getConnection();
        ...
        ResultSet rs = ordre.executeQuery();
        ArrayList<Client_Old> clients = new ArrayList<Client_Old>();
        while (rs.next()) {
            clients.add(new Client_Old(rs.getString("CIVILITY"), rs.getString("NAME"), rs.getString("FIRST_NAME"),
                    rs.getDate("BIRTH_DATE"), rs.getString("BIRTH_PLACE"), rs.getString("SEX"),
                    rs.getString("NATIONALITY"), rs.getInt("NBER"), rs.getString("STREET"),
                    rs.getString("ADDITIONAL"), rs.getInt("ZIP_CODE"), rs.getString("CITY"),
                    rs.getString("COUNTRY"), rs.getInt("PHONE_MOBIL"), rs.getInt("PHONE_HOME"),
